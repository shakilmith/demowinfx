...
int WindowsDirectives() {
    ...
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:ERROR_SUCCESS:PropertyInfo:size=%llu\n", ((unsigned long long)sizeof(ERROR_SUCCESS)));
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:ERROR_SUCCESS:PropertyInfo:signedness=$%s$\n", ((ERROR_SUCCESS>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:ERROR_SUCCESS:PropertyInfo:value=%llX\n", ((unsigned long long)ERROR_SUCCESS));
    ...
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:TLS_OUT_OF_INDEXES:PropertyInfo:size=%llu\n", ((unsigned long long)sizeof(TLS_OUT_OF_INDEXES)));
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:TLS_OUT_OF_INDEXES:PropertyInfo:signedness=$%s$\n", ((TLS_OUT_OF_INDEXES>=0 ? 1 : 0)) ? "UNSIGNED" : "SIGNED");
    printf("NativeCodeInfo:WindowsDirectives:ConstantInfo:TLS_OUT_OF_INDEXES:PropertyInfo:value=%llX\n", ((unsigned long long)TLS_OUT_OF_INDEXES));
